 ...
 */
class SAML2Adapter extends BaseSSOAdapter_js_1.BaseSSOAdapter {
    providerName = 'SAML2';
    constructor(config) {
        super(config);
    }
    ...
    getAuthorizationUrl(state) {
        const id = `_${crypto_1.default.randomUUID()}`;
    ...
    async handleCallback(samlResponse) {
        ...
        return {
            profile,
            tokens: {
                accessToken: `saml-session-${crypto_1.default.randomUUID()}`,
                tokenType: 'SAML',
            },
     ...
     */
    async validateToken(samlResponse) {
...
exports.SAML2Adapter = SAML2Adapter;
