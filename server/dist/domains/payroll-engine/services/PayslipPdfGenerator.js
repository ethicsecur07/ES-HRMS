...
exports.PayslipPdfGenerator = void 0;
const pdfkit_1 = __importDefault(require("pdfkit"));
class PayslipPdfGenerator {
    static generate(payslip, employee, organization, stream) {
        return new Promise((resolve, reject) => {
            ...
            doc.strokeColor('#e2e8f0').lineWidth(1).moveTo(50, doc.y).lineTo(545, doc.y).stroke();
            doc.moveDown(1);
            doc.fillColor('#64748b').fontSize(8).text('This is a computer-generated document authorized by the finance department of ' +
                organization.name +
                '. No physical signature is required. Generated on ' +
                new Date(payslip.generatedAt).toLocaleString(), { align: 'center' });
            doc.end();
...
exports.PayslipPdfGenerator = PayslipPdfGenerator;
