...
router.post('/:id/schedule-interview', auth_middleware_js_1.authenticate, (0, rbacGuard_js_1.rbacGuard)('RECRUITMENT', 'edit'), recruitment_controller_js_1.scheduleInterview);
