...
exports.taskVisibilityMiddleware = void 0;
const User_js_1 = require("../models/User.js");
const Employee_js_1 = require("../models/Employee.js");
const taskVisibilityMiddleware = async (req, res, next) => {
    try {
        ...
        if (role === 'EMPLOYEE') {
            ...
            if (!employeeId) {
                req.taskFilter = { employeeId: new User_js_1.User()._id }; // Matches nothing
                return next();
            }
...
exports.taskVisibilityMiddleware = taskVisibilityMiddleware;
