...
router.get('/azure-licenses', auth_middleware_js_1.authenticate, (0, rbacGuard_js_1.rbacGuard)('EMPLOYEES', 'view'), employee_controller_js_1.getAzureLicenses);
...
router.post('/:id/convert-to-fulltime', auth_middleware_js_1.authenticate, (0, rbacGuard_js_1.rbacGuard)('EMPLOYEES', 'edit'), employee_controller_js_1.convertToFullTime);
