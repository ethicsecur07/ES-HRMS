...
exports.generatePayslipPdf = void 0;
const pdfkit_1 = __importDefault(require("pdfkit"));
const Employee_js_1 = require("../models/Employee.js");
const Organization_js_1 = require("../models/Organization.js");
const stream_1 = require("stream");
const generatePayslipPdf = async (payslip) => {
    const employee = await Employee_js_1.Employee.findById(payslip.employeeId);
    const organization = await Organization_js_1.Organization.findById(payslip.organizationId);
