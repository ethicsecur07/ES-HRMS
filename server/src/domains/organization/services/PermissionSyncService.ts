...
export class PermissionSyncService {
   ...
   */
  static async syncForTenant(orgId: mongoose.Types.ObjectId, session?: mongoose.ClientSession): Promise<void> {
    try {
      logger.info(`🔑 Synchronizing role permissions for organization: ${orgId}`);
