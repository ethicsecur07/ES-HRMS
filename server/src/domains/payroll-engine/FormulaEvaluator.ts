import { ISalaryComponent } from '../../models/payroll/SalaryComponent.js';
...
export class FormulaEvaluator {
   ...
   */
  public static evaluate(formula: string, variables: Record<string, number>): number {
    try {
   ...
   */
  public static evaluateCondition(expression: string, variables: Record<string, number>): boolean {
    try {
