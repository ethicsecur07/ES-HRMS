...
router.get('/settings', authenticate as any, authorize(['ADMIN']) as any, getSettings as any);
router.put('/settings', authenticate as any, authorize(['ADMIN']) as any, updateSettings as any);
