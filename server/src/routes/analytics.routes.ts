...
import { getDashboardStats, getAuditLogs, getSettings, updateSettings, getAnnouncementsAndActions } from '../controllers/analytics.controller.js';
...
router.get('/announcements-actions', authenticate as any, getAnnouncementsAndActions as any);
